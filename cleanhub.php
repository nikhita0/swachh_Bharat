...
$sql = "SELECT Loc_name from cleaned_place where Pin_no in(SELECT Pin_no from Location where Ad_no in(SELECT Aadhar_no from citizen where Aadhar_no=".$ad."))";
...
$sql = "SELECT * FROM cleaned_place  where Loc_name='Bengaluru' group by pin_no";
